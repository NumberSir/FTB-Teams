...
public interface TeamManager {
    ...
    /// @return the player's team (maybe a party team), or `Optional.empty()` if no team could be found
    ...
    /// @return the player's personal team, or `Optional.empty()` if no team could be found
    ...
    /// @return the team, or `Optional.empty()` if no team could be found
    ...
    ///
    /// @param commandSourceStack the command source, typically [MinecraftServer#createCommandSourceStack()]
    ...
    /// See [#createServerTeam(CommandSourceStack, String, String, Color4I, UUID)]. This variant passes a null UUID,
    ...
    /// See [#setChatRedirected(ServerPlayer, boolean)] for more information.
    ///
    /// @param player the player
